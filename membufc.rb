class Membufc < Formula
  ...
  url "https://github.com/orbs-network/membuffers/archive/0.0.11.tar.gz"
  sha256 "f8f87a960e430dd76b405b53d3279ff8aa8a27f506d3bf546caad81fef4e3140"
  ...
  test do
    ...
    assert_match "membufc 0.0.11", shell_output("#{bin}/membufc --version 2>&1", 2)
  end
end
